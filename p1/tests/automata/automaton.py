...
class FiniteAutomaton(
    ...
    def to_deterministic(
        ...
        new_initial_state = State("q0_deterministic_0", is_final=self.initial_state.is_final)
        ...
        print("initial: ", new_states_list[i])
                ...
                if t.initial_state in state.states_in and t.symbol == s:
                    if state_reached_with_s is None:
                        state_reached_with_s = State(
                            name=t.final_state.name + "_deterministic_" + str(self.number_states_deterministic),
